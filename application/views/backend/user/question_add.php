<form action="<?php echo site_url('course/kuizi/pyetjet/quiz_questions/'.$param2.'/add'); ?>" method="post" id = 'mcq_form'>
...
function showOptions(number_of_options){
    $.ajax({
        type: "POST",
        url: "<?php echo site_url('course/kuizi/pyetjet/manage_multiple_choices_options'); ?>",
...
$('#submitButton').click( function(event) {
    $.ajax({
        url: '<?php echo site_url('course/kuizi/pyetjet/quiz_questions/'.$param2.'/add'); ?>',
        type: 'post',
