                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <ul class="nav justify-content-md-end footer-menu">
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo site_url('profile/about_us'); ?>"><?php echo get_phrase('about'); ?></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo site_url('profile/privacy_policy'); ?>"><?php echo get_phrase('privacy_policy'); ?></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo site_url('profile/terms_and_condition'); ?>"><?php echo get_phrase('terms_&_condition'); ?></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo site_url('profile/login'); ?>">
...
<!--pjesen e javascript duhet me kuptu-->
        <script type="text/javascript">
            function publishRating(course_id) {
                ...
                $.ajax({
                    type : 'POST',
                    url  : '<?php echo site_url('feedbacks/rate/rate_course'); ?>',
