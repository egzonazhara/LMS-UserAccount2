                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    ...
                    <?php if (get_settings('allow_instructor') == 1): ?>
                        <div class="instructor-box menu-icon-box">
                            <div class="icon">
                                ...
                                <a href="<?php echo site_url('useraccount/teacherr'); ?>" style="border: 1px solid transparent; margin: 10px 10px; font-size: 14px; width: 100%; border-radius: 0;"><?php echo get_phrase('user'); ?></a><!---->
                            </div>
                        </div>
                    ...
                    <div class="dropdown user-dropdown corner-triangle top-right">
                        <ul class="user-dropdown-menu">
                            ...
                            <li class="user-dropdown-menu-item"><a href="<?php echo site_url('useraccount/profile/profile/user_profile'); ?>"><i class="fas fa-user"></i><?php echo get_phrase('user_profile'); ?></a></li>
                            
                            <li class="dropdown-user-logout user-dropdown-menu-item"><a href="<?php echo site_url('useraccount/login/logout/user'); ?>"><?php echo get_phrase('log_out'); ?></a></li>
                        </ul>
                    </div>
                </div>
