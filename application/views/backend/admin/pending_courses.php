...
<ol class="breadcrumb bc-3">
    <li>
        <a href="<?php echo site_url('useraccount/profile/dashboard'); ?>">
            ...
            <div class="panel-body">
              <div class="row">
                  <div class="col-md-4 col-md-offset-4">
                      <a href = "<?php echo site_url('course/course/course_form/add_course'); ?>" class="btn btn-block btn-info btn-lg" type="button"><i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo get_phrase('add_course'); ?></a>
                  </div>
              </div>
              <hr>
              <table class="table table-bordered" id="table-2">
                  ...
                  <tbody>
                      <?php
                          ...
                          <tr>
                              ...
                              <td hidden>
                                  <ul style="list-style-type:square">
                                      ...
                                      <a href="<?php echo site_url('course/course/watch_video/'.slugify($lesson['title']).'/'.$lesson['id']); ?>"><li><?php echo $lesson['title']; ?></li></a>
                                  <?php endforeach; ?>
                              </ul>
                          </td>
                          <td>
                          ...
                          <td>
                              <?php
                              $enrol_history = $this->administratori_model->enrol_history($course['id']);
                          ...
                          <td>
                              <div class="btn-group">
                                  ...
                                  <ul class="dropdown-menu">
                                      ...
                                      <li>
                                          <a href="<?php echo site_url('course/course/sections/'.$course['id']); ?>">
                                              <?php echo get_phrase('manage_section');?>
                                          </a>
                                      </li>

                                      <li>
                                          <a href="<?php echo site_url('course/course/lessons/'.$course['id']); ?>">
                                      ...
                                      <li>
                                          ...
                                          <?php else: ?>
                                              <a href="#" onclick="confirm_modal('<?php echo site_url();?>course/course/change_course_status_for_admin/active/<?php echo $course['id'];?>', 'generic_confirmation');">
                                                  <?php echo get_phrase('mark_as_active');?>
                                              </a>
                                          <?php endif; ?>
                                      </li>
                                      ...
                                      <li>
                                          <a href="<?php echo site_url('course/course/course_form/course_edit/'.$course['id']) ?>">
                                      ...
                                      <li class="divider"></li>
                                      <li>
                                          <a href="#" onclick="confirm_modal('<?php echo site_url('course/course/course_actions/delete/'.$course['id']); ?>');">
...
<script type="text/javascript">
    function ajax_get_sub_category(category_id) {
        $.ajax({
            url: '<?php echo site_url('course/kategorite/ajax_get_sub_category/');?>' + category_id ,
