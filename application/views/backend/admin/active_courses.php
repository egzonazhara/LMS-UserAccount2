                ...
                <td>
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <a href="<?php echo site_url('course/ligjerata/lessons/'.$course['id']); ?>">
                            ...
                            <li>
                                ...
                                <?php else: ?>
                                    <a href="#" onclick="confirm_modal('<?php echo site_url();?>course/course/change_course_status_for_admin/pending/<?php echo $course['id'];?>', 'generic_confirmation');">
                                        <?php echo get_phrase('mark_as_pending');?>
                                    </a>
                                <?php endif; ?>
                            </li>
