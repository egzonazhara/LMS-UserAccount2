    ...
    <li>
        <div class="course-box-2">
            ...
            <div class="course-price-rating">
                ...
                <div class="rating">
                    <?php
                        $total_rating =  $this->feedback_model->get_ratings('course', $course['id'], true)->row()->rating;
                        $number_of_ratings = $this->feedback_model->get_ratings('course', $course['id'])->num_rows();
                ...
                <div class="rating-number">
                    <?php echo $this->feedback_model->get_ratings('course', $course['id'])->num_rows().' '.get_phrase('ratings'); ?>
                </div>
            </div>
        </div>
    </li>
