            ...
            <div class="col">
                <div class="user-dashboard-box">
                    <div class="user-dashboard-sidebar">
                        ...
                        <div class="user-dashboard-menu">
                            <ul>
                                ...
                                <li class="active"><a href="<?php echo site_url('profile/profile/user_credentials'); ?>"><?php echo get_phrase('account'); ?></a></li>
                                <li><a href="<?php echo site_url('profile/profile/user_photo'); ?>"><?php echo get_phrase('photo'); ?></a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="user-dashboard-content">
                        ...
                        <form action="<?php echo site_url('useraccount/profile/update_profile/update_credentials'); ?>" method="post">
