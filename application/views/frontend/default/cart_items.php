...
<div class="dropdown course-list-dropdown corner-triangle top-right"> <!-- Just remove the display none from the css to make it work -->
	<div class="list-wrapper">
		...
		<div class="dropdown-footer">
			...
			<a href = "<?php echo site_url('payment/cart/shopping_cart'); ?>"><?php echo get_phrase('go_to_cart'); ?></a>
		</div>
	</div>
...
function showCartPage() {
	window.location.replace("<?php echo site_url('payment/cart/shopping_cart'); ?>");
}
</script>
