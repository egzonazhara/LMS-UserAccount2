    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="header-title mb-3"><?php echo get_phrase('user_add_form'); ?></h4>

                <form class="required-form" action="<?php echo site_url('useraccount/profile/users/add'); ?>" enctype="multipart/form-data" method="post">
