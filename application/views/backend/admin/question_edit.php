...
?>
<form action="<?php echo site_url('course/kuizi/pyetjet/quiz_questions/'.$param3.'/edit/'.$param2); ?>" method="post" id = 'mcq_form'>
...
function showOptions(number_of_options){
    $.ajax({
        type: "POST",
        url: "<?php echo site_url('course/kuizi/opsionet/manage_multiple_choices_options'); ?>",
...
$('#submitButton').click( function(event) {
    $.ajax({
        url: '<?php echo site_url('course/kuizi/pyetjet/quiz_questions/'.$param3.'/edit/'.$param2); ?>',
        type: 'post',
