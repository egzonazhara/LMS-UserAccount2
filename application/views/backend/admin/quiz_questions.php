...
function deleteQuizQuestionAndReloadModal(quizID, questionID) {
    var deletionURL = '<?php echo site_url(); ?>'+'course/kuizi/pyetjet/quiz_questions/'+quizID+'/delete/'+questionID;
...
function sort() {
    ...
    $.ajax({
        url: '<?php echo site_url('course/kuizi/opsionet/ajax_sort_question/');?>',
        type : 'POST',
