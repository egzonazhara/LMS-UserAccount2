<?php
    ...
    $number_of_enrolment = $this->administratori_model->enrol_history()->num_rows();
        ...
        <div class="card widget-inline">
            <div class="card-body p-0">
                <div class="row no-gutters">
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <a href="<?php echo site_url('administratori/enrollment/enrol_history'); ?>" class="text-secondary">
                            <div class="card shadow-none m-0 border-left">
                                <div class="card-body text-center">
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <a href="<?php echo site_url('useraccount/profile/users'); ?>" class="text-secondary">
                            <div class="card shadow-none m-0 border-left">
                                <div class="card-body text-center">
        ...
        <div class="card" id = 'unpaid-instructor-revenue'>
            <div class="card-body">
                <h4 class="header-title mb-3"><?php echo get_phrase('unpaid_teacher_revenues'); ?>
                    <a href="<?php echo site_url('administratori/enrollment/instructor_revenue'); ?>" class="alignToTitle" id ="go-to-instructor-revenue"> <i class="mdi mdi-logout"></i> </a>
                </h4>
