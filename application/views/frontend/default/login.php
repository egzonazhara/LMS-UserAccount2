    ...
    <div class="container-lg">
        <div class="row">
            <div class="col">
                <nav>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?php echo site_url('profile'); ?>"><i class="fas fa-home"></i></a></li>
            ...
            <div class="col-lg-9">
              <div class="user-dashboard-box mt-3">
                  <div class="user-dashboard-content w-100 login-form">
                      ...
                      <form action="<?php echo site_url('useraccount/login/validate_login/user'); ?>" method="post">
                  ...
                  <div class="user-dashboard-content w-100 register-form hidden">
                      ...
                      <form action="<?php echo site_url('useraccount/login/register'); ?>" method="post">
                          <div class="content-box">
                              <div class="basic-group">
                                  <div class="form-group">
                  ...
                  <div class="user-dashboard-content w-100 forgot-password-form hidden">
                      ...
                      <form action="<?php echo site_url('useraccount/login/forgot_password/frontend'); ?>" method="post">
                          <div class="content-box">
                              <div class="basic-group">
                                  <div class="form-group">
