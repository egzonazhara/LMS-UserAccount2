...
<section class="home-fact-area">
    <div class="container-lg">
        <div class="row">
            <?php $courses = $this->user_model->get_courses(); ?>
            <div class="col-md-4 d-flex">
                <div class="home-fact-box mr-md-auto ml-auto mr-auto">
                    <i class="fas fa-bullseye float-left"></i>
                    <div class="text-box">
                        <h4><?php
                        $status_wise_courses = $this->user_model->get_status_wise_courses();
        ...
        <div class="row">
            <div class="col">
                ...
                <div class="course-carousel">
                    <?php $top_courses = $this->user_model->get_top_courses()->result_array();
                        ...
                        <a href="<?php echo site_url('home/course/'.slugify($top_course['title']).'/'.$top_course['id']); ?>" class="has-popover">
                            <div class="course-box">
                                ...
                                <div class="course-details">
                                    ...
                                    <div class="rating">
                                        <?php
                                        $total_rating =  $this->user_model->get_ratings('course', $top_course['id'], true)->row()->rating;
    ...
    <div class="container-lg">
        <div class="row">
            <div class="col">
                ...
                <div class="course-carousel">
                    <?php
                    $latest_courses = $this->user_model->get_latest_10_course();
                    foreach ($latest_courses as $latest_course):?>
                    <div class="course-box-wrap">
                        <a href="<?php echo site_url('home/'.slugify($latest_course['title']).'/'.$latest_course['id']); ?>">
                            <div class="course-box">
                                <div class="course-image">
                                ...
                                <div class="course-details">
                                    ...
                                    <div class="rating">
                                        <?php
                                        $total_rating =  $this->user_model->get_ratings('course', $latest_course['id'], true)->row()->rating;
