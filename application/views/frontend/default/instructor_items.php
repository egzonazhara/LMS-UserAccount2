    ...
    <div class="list-wrapper">
        <div class="item-list">
            <ul>
                ...
                <li style="padding:15px 20px;"><a href="<?php echo site_url('administratori/settings/payment_settings'); ?>" style="color: #000000;"><?php echo get_phrase('payment_settings'); ?></a></li>
            </ul>
        </div>
    </div>
</div>
