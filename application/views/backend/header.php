    ...
    <div class="container-fluid">
        ...
        <ul class="list-unstyled topbar-right-menu float-right mb-0">
            ...
            <?php if (strtolower($this->session->userdata('role')) == 'admin'): ?>
                <!-- settings-->
                <a href="<?php echo site_url('administratori/settings/system_settings'); ?>" class="dropdown-item notify-item">
            ...
            <!-- Logout-->
            <a href="<?php echo site_url('useraccount/login/logout'); ?>" class="dropdown-item notify-item">
